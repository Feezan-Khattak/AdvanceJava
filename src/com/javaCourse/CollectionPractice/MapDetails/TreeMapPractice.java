...
public class TreeMapPractice {
    public static void main(String[] args) {
        ...
        // different implementation like hash map, tree map.
        // tree map is similar to hash map but the basic difference is that in tree map we
        // have order insertion but in hash map there is no ordered insertion
